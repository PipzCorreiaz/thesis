...
Additionally, the \acp{fgr}, presented in Figure~\ref{fig:ABC-fr}, measure the effectiveness of players when competing with each other.
...
The scenario (d, yellow) has its Gaussian fitting curve nearly coincident with the scenario (a), suggesting one Trick player in a team does not influence the results.
On the other hand, scenario (e, orange) has a higher distribution between 60 and 80 points.
