...
\hypersetup{ a4paper=true,
             ...
             bookmarksopen=true,
             pdftitle={EMYS: A Social Robot that Plays ``Sueca''},                 % EDIT THIS LINE
             pdfauthor={Filipa Isabel Nogueira Correia},                    % EDIT THIS LINE
             pdfsubject={EMYS: A Social Robot that Plays ``Sueca''},                  % EDIT THIS LINE
             pdfcreator={Filipa Isabel Nogueira Correia}, % EDIT THIS LINE
